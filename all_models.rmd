...
result_1 <- run_model(yData = se_combo_drop_nieve, xDataFormula = (~se_combo_drop_nieve$cohort + se_combo_drop_nieve$age_at_csf), maxIterOptimize = 400)
```

#Model2 (univariate batch)
```{r model 2 (univariate batch)}
result_2 <- run_model(yData = se_combo_drop_nieve, xDataFormula = (~se_combo_drop_nieve$cohort + se_combo_drop_nieve$batch), maxIterOptimize = 400)
```
