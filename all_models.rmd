...
result_5 <- run_model(Y = se_combo_drop_nieve, xFormula = (~se_combo_drop_nieve$cohort +
...
model_4_combo_drop_nieve <- c(
  "Cohort + Total Gene Counts",
  result_4$ZI_aic_4,
  result_4$ZI_ll_4,
  result_4$ZI_df_4,
  result_4$NB_aic_4,
...
model_5_combo_drop_nieve <- c(
  "Cohort + Non Zero Gene Counts + Total Gene Counts",
  result_5$ZI_aic_5,
  result_5$ZI_ll_5,
  result_5$ZI_df_5,
  result_5$NB_aic_5,
