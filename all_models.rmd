...
source("load_data.R")
loaded_data <- load_data("./data/gene_count_lazar_1000.csv", "./data/meta_data_lazar.csv")
...
#ZINB
zinb_nieve_cohort_1 <- zinbFit(
  se_combo_drop_nieve,
  K = 2,
  X = model.matrix(
    ~se_combo_drop_nieve$cohort + se_combo_drop_nieve$age_at_csf,
...
#ZINB
zinb_nieve_cohort_2 <- zinbFit(
  se_combo_drop_nieve,
  K = 2,
  X = model.matrix(
    ~se_combo_drop_nieve$cohort + se_combo_drop_nieve$batch,
    data = colData(se_combo_drop_nieve)
  ),
  BPPARAM = BiocParallel::SerialParam(),
  maxiter.optimize = 400,
