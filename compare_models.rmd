...
is_counts_data_prepared <- FALSE

if (is_counts_data_prepared) {
  se <- SummarizedExperiment(
    assays = list(counts = read_csv('./input/some_already_prepared_counts_data_with_quartiles_etc.csv')),
    colData = data.frame(read_chunk('./input/some_already_prepared_metadata.csv'))
  )
} else {
  source("functions.R")
  se <- summarized_experiment_with_quartiles(
